...
#include <libweb3jsonrpc/AdminATC.h>
...
string ATCCredits(bool _interactive = false)
{
...
void version()
{
	cout << "ATC version " << dev::Version << endl;
	cout << "ATC network protocol version: " << dev::ATC::c_protocolVersion << endl;
	cout << "Client database version: " << dev::ATC::c_databaseVersion << endl;
	cout << "Build: " << DEV_QUOTED(ATC_BUILD_PLATFORM) << "/" << DEV_QUOTED(ATC_BUILD_TYPE) << endl;
	exit(0);
}
