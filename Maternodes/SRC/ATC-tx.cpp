...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("ATCd Core ATC-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ATC-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ATC transaction") + "\n" +
              "  ATC-tx [options] -create [commands]   " + _("Create hex-encoded ATC transaction") + "\n" +
              "\n";
